    ...
    <>
      ...
      <Card className="mt-6 overflow-x-auto">
        <table className="w-full text-sm">
          ...
          <tbody>
            {loading ? (
              <tr><td colSpan={3} className="py-8 text-center text-ink/40">Loading...</td></tr>
            ) : payouts.length === 0 ? (
              <tr><td colSpan={3} className="py-8 text-center text-ink/40">No payout records yet.</td></tr>
            ) : (
              payouts.map((p) => (
